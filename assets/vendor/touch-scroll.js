(function ($) {
  ...
  debiki.Utterscroll = (function () {
    ...
    let $elemToScroll;
    const scrollstoppers = 'a, area, button, input, select, textarea, .no-scroll, .noscroll, .MuiSlider-root, .MuiDialog-root, .picker-item';
    ...
    function findScrollable($el) {
      return $el.closest('*').filter(function () {
        const $t = $(this);
        const y = $t.css('overflow-y'), x = $t.css('overflow-x');
